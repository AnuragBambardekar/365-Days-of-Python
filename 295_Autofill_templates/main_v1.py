...
def fill_invitation(template_path, output_path, data):
    ...
    try:
        doc = docx.Document('295_Autofill_templates/template.docx')
        ...
        print("Template successfully filled and saved.")
    except ModuleNotFoundError:
        print("Error: Template file not found at the specified path.")
...
if __name__ == "__main__":
    ...
    data = {
        ...
        '[Salutation]':'Mr',
        '[Recipient Name]':'Mike',
        '[Recipients Job Title]':'Sr. Engineer',
