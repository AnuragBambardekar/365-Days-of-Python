...
class PomodoroTimer:
    def __init__(self):
        ...
        self.root.tk.call('wm', 'iconphoto', self.root._w, PhotoImage(file="160_Pomodoro_Timer/tomato.png"))
    ...
    def play_alarm(self):
        winsound.PlaySound("160_Pomodoro_Timer/alarm.wav", winsound.SND_FILENAME)
